...
const FamilyMessages = () => {
  ...
  return (
    <div>
      <PageHeader title="Messages" subtitle="Vos conversations avec les au pairs et l’équipe." />
          ...
          <>
            <aside className="messages-list">
              {conversations.length === 0 ? (
                <EmptyState title="Messagerie vide" description="Vos échanges s’afficheront ici dès qu’une conversation sera ouverte." />
              ) : (
